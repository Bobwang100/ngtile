...
validresult = tf.argmax(resnet.inference(validrecord_images, False, filters, n, ver), axis=1)
testresult = tf.argmax(resnet.inference(testrecord_images, False, filters, n, ver), axis=1)
