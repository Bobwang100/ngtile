...
def train():
    # saver.restore(sess, './model_vgg16_1120/transfer_learn_350000')
    # saver.restore(sess, './model_vgg16_1120/transfer_learn_350000')
    ...
    for i in range(1000000):
        ...
        if i % 5000 == 0:
            saver.save(sess, './model_vgg16_1122/transfer_learn_%d' % i)
    ...
    saver.save(sess, './model_vgg16_1122/transfer_learn')


def test():

    # saver.restore(sess, './model_vgg16_1122/transfer_learn_95000')
